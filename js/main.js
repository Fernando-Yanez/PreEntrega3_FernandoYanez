...
const registroUsuario = document.querySelector('.registroPersona');
//const inicioSesion = document.querySelector('.inicioSesion')


//Eventro para mostrar el formulario de registro de persona
...
//Evento para realizar el formulario de inic io de sesion

botonRegistrado.addEventListener('click', (event) => {
